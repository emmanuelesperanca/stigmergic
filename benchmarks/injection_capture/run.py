"""Run the Stigmergic injection-capture benchmark and write a report.
...
def _parse_args(argv: list[str] | None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Stigmergic injection-capture benchmark.",
...
This benchmark measures the Stigmergic Byzantine quorum as an anti-prompt-
