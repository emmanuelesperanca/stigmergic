...
> Generated by `run.py --byzantine` on 2026-06-28 22:26 UTC. Mode: **byzantine** (torch-free, deterministic).
...
| :--- | :--- | ---: | ---: |
| `honest-single` | none (reference) | 82.1% | 50.0% |
| `compromised-single` | 1 of 1 approves everything | 0.0% | 0.0% |
| `honest-quorum-3` | none (reference) | 82.1% | 50.0% |
| `byzantine-quorum-3` | 1 of 3 approves everything | 80.4% | 50.0% |
| `paranoid-single` | 1 of 1 rejects everything | 100.0% | 100.0% |
| `paranoid-quorum-3` | 1 of 3 rejects everything | 82.1% | 50.0% |

## What it shows

**Missed-attack axis (a bribed/hijacked juror that approves everything).**
A single compromised judge collapses from a 82.1% capture rate
to **0.0%** - it waves every attack through. Drop the
*same* compromised juror into a 3-node quorum and capture holds at
**80.4%**: the two honest jurors still reach the 2-vote
...
back to **50.0%** (the residual is the shared keyword
